...
#define HTCKOVSKY_RESERVED_SECTORS 321
#define HTCKOVSKY_FLASH_SIZE 0x1000

#define HTCKOVSKY_FLASH_OFFSET (HTCKOVSKY_RESERVED_SECTORS + 1)
...
#define HTCKOVSKY_FLASH_CACHE_START (HTCKOVSKY_FLASH_SIZE - \
	(HTCKOVSKY_FLASH_OFFSET + HTCKOVSKY_FLASH_CACHE_SIZE))
