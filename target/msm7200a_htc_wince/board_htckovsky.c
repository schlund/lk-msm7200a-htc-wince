...
//Reserved so that we can flash LK via RUU and it is not exported to linux
#define HTCKOVSKY_FLASH_LK_SIZE 2

#define HTCKOVSKY_FLASH_RECOVERY_START HTCKOVSKY_FLASH_LK_SIZE
...
#define HTCKOVSKY_FLASH_MISC_SIZE 3
