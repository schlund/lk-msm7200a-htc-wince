...
#define HTCPHOTON_FLASH_OFFSET (HTCPHOTON_RESERVED_SECTORS)

#define HTCPHOTON_FLASH_LK_START 0
#define HTCPHOTON_FLASH_LK_SIZE 1

#define HTCPHOTON_FLASH_BOOT_START (HTCPHOTON_FLASH_LK_START + \
	HTCPHOTON_FLASH_LK_SIZE)
#define HTCPHOTON_FLASH_BOOT_SIZE 0x50

#define HTCPHOTON_FLASH_RECOVERY_START (HTCPHOTON_FLASH_BOOT_START + \
...
#define HTCPHOTON_FLASH_SYS_START (HTCPHOTON_FLASH_MISC_START + \
	HTCPHOTON_FLASH_MISC_SIZE)
#define HTCPHOTON_FLASH_SYS_SIZE 0x500

#define HTCPHOTON_FLASH_DATA_START (HTCPHOTON_FLASH_SYS_START + \
	HTCPHOTON_FLASH_SYS_SIZE)
#define HTCPHOTON_FLASH_DATA_SIZE 0x890
